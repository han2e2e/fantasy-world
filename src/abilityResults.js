...
export const JOB_DETAILS = {
  ...
  extinction: {
    ...
    combo: 'Survival',
    personalityDesc:
      '당신은 문답을 진행하는 내내 극한의 압박감과 절망적인 선택지 앞에서도 절대로 무너지지 않는 \'강인한 정신력과 생존 본능\'을 증명해 보였습니다. 당신은 위기가 찾아오면 움츠러드는 것이 아니라, 오히려 상황이 파국으로 치달을수록 무서운 집중력을 발휘하며 판을 뒤집어엎을 기회를 노리는 독종에 가깝습니다. 남들이 고통과 두려움에 마비될 때, 당신은 그 고통을 성장의 촉매제이자 리미터를 해제하는 트리거로 삼아 상황을 장악해 나가는 타입입니다. 몰릴 때마다 오히려 투지가 샘솟고 죽음의 문턱에서 가장 강력한 반격을 시작하는 당신의 불굴의 기질은, 세포가 파괴될수록 파괴력이 폭발하는 그 어떤 가혹한 환경에서도 기어코 살아남아 승리를 쟁취하는 \'멸진체\'의 영혼과 소름 돋도록 일치합니다.',
    abilityDesc:
  ...
  war_god: {
    ...
    combo: 'Pure',
    personalityDesc:
      '당신은 10개의 질문을 거치는 동안 복잡한 잔꾀나 교묘한 회피, 시스템적 계산을 전부 거부한 채 오직 정면돌파와 완벽한 정답만을 추구하는 \'압도적인 힘의 신봉자\'입니다. 당신에게 우회로나 타협은 부차적인 수단일 뿐, 본질은 그 어떤 가로막는 장벽과 난제도 내 손으로 직접 부수고 전진하겠다는 압도적인 패기와 기백을 품고 있습니다. 타협을 모르는 뚝심과 낯선 세계를 내 발밑에 무릎 꿇리겠다는 거대한 지배욕, 그리고 어떤 위험 앞에서도 눈 하나 깜짝하지 않고 정면으로 맞서 싸우는 대담함. 오직 정면 승부만을 갈망하며 존재 자체만으로도 주변의 공기를 물리적인 위압감으로 짓누르는 당신의 파괴적인 영혼은, 운명을 개척하는 무력의 현현이자 \'투신\'이라 불리는 존재의 자리에 오르기에 한 치의 부족함도 없습니다.',
    abilityDesc:
  ...
  abyss: {
    ...
    combo: 'Pure',
    personalityDesc:
      '당신은 문답을 거치는 동안 물리적인 완력이나 단순한 과학 기술, 방어 체계의 구축을 전부 넘어서서 오직 사람의 심리와 본질적인 판의 흐름만을 장악하려 하는 \'절대적인 지략가\'의 성향을 띠고 있습니다. 당신에게 단순한 육체적 충돌은 무의미합니다. 모든 상황의 수와 상대의 무의식을 수천 수만 갈래로 미리 들여다보고, 타인이 \'가장 완벽하다고 믿는 전략\'마저 내 손안에서 놀아나게 만듭니다. 직접 힘을 소모할 필요도 없이, 보이지 않는 배후에서 모든 관계의 인지 구조를 뒤틀어 스스로 자멸하는 경로를 찾아내게 만드는 판짜기의 극치. 주변이 승리를 확신하는 그 순간마저 당신이 짜놓은 거대한 덫 안이었음을 깨닫게 만드는 당신의 초월적인 지적 혜안은, 지성체들의 인지를 완벽히 조율하는 심연의 주권자 \'아비스\'의 좌에 앉기에 완벽한 자격을 갖추고 있습니다.',
    abilityDesc:
  ...
  counter: {
    ...
    combo: 'Combat',
    personalityDesc:
      '당신은 문답 속에서 위기가 가로막았을 때, 무작정 성급하게 문제를 해결하기 급급하기보다 폭풍이 지나갈 때까지 묵묵히 버텨내고 타이밍을 재는 \'탁월한 인내심과 뚝심\'을 보여주었습니다. 당신의 회피는 두려움이 아닙니다. 자신에게 가해지는 리스크와 압박감을 고스란히 체내에 축적해 두었다가, 단 한 번의 결정적인 기회에 폭발적으로 되돌려주기 위한 영리한 준비 단계입니다. 남들이 충격에 쓰러질 때 고통을 인내하고 축적하여 반전의 기회를 노리고, 무작정 부딪히기보다 상대를 관찰하고 패턴을 읽는 치밀함. 따라서 당신의 반격은 늘 예상을 웃돌고 치명적입니다. 또한 외부의 모든 위험과 위협을 나의 배터리로 삼아 상황의 완전한 역전을 설계하는 당신의 역발상적인 생존 본능은, 가해지는 에너지를 압축하여 되돌려주는 \'반인체\'의 각인을 일깨우기에 충분합니다.',
    abilityDesc:
  ...
  puppet: {
    ...
    combo: 'Pure',
    personalityDesc:
      '당신은 10개의 운명적인 질문을 관통하는 동안 이세계 특유의 신비주의나 마법, 검술의 낭만을 전부 거부한 채 모든 현상을 오직 \'시스템의 규칙과 데이터\'로만 해석하려 한 효율성의 극치이자 절대적인 이성주의자입니다. 당신에게 이세계의 초월적인 권능들은 경외의 대상이 아닙니다. 그저 백스테이지에서 패킷을 가로채고 소스코드를 뜯어 수정할 수 있는 프로그램 버그에 불과합니다. 규칙과 인과가 소용돌이치는 미지의 차원 한복판에서 홀로 시스템의 허점을 해킹하고, 상황의 코드를 덮어써 내 것으로 복사해 버리는 초차원적인 사고방식. 세상이 정해둔 절대적 룰을 비웃으며 마스터 키보드 하나로 세계의 마스터 권한을 찬탈해 버리는 당신의 비범한 천재성은, 이세계 최초이자 유일무이한 시스템 크래커 \'퍼핏\'의 좌에 앉을 유일한 자격을 증명합니다.',
    abilityDesc:
  ...
  pirouette: {
    ...
    personalityDesc:
      '당신은 10개의 문답 앞에서 파괴적인 실행력과 치밀한 지략의 완벽한 동률, 전체 플레이어 중 오직 극소수만이 도달하는 이 기적적인 황금 비율을 만들어냈습니다. 세계의 인과율은 일시적인 연산 오류를 일으키며 당신을 잔혹한 인형사 \'피루엣\'의 히든 각인으로 재정의했습니다. 당신은 파괴를 계획하는 동시에 실행하며, 파멸이 일어나는 그 짧은 찰나에도 이미 다음 수의 결말을 완성해 두는 잔인한 천재입니다. 무모한 난타전에 얽히지 않은 채 보이지 않는 백스테이지에서 실을 쥐고, 세계의 관계 구조와 타인의 심리를 찬탈해 손가락 하나로 조종하는 절대적인 지배력. 그 누구도 감지하지 못하는 차가운 인형극의 무대를 완성하고 마주하는 모든 재앙을 걸어 다니는 체스말로 부려 먹는 당신의 초차원적인 영리함은, 이 세계관에서 오직 단 한 명에게만 허락된 절대적 주권자의 증거입니다.',
    abilityDesc:
  ...
  mansang: {
    ...
    personalityDesc:
      '보통 사람은 위기 앞에서 싸우거나 도망칩니다. 하지만 당신은 질문을 통과하는 내내 두 가지를 동시에 선택했습니다. 이것은 우유부단함이 아닙니다. 파괴와 보존이라는 우주의 두 원리가 당신 안에서 전쟁 없이 공존하고 있다는 증거입니다. 삶을 갈망하는 생의 의지와, 모든 것을 파괴하는 사멸의 의지가 영혼의 천칭 위에서 완벽한 수평을 이루고 있는 상태입니다. 세계는 이 두 극단의 권능이 하나로 묶인 당신을 필멸자가 아닌 \'반신의 격\'으로 판정했습니다. 자신을 향해 몰려드는 세상의 적의와 혼돈의 인과율을 손짓 하나로 무력화시키고, 오직 단 한 걸음의 움직임만으로 온 세상의 생사여탈권을 쥐고 흔드는 절대적인 균형자. 파괴와 보존이라는 두 가지 우주적 법칙을 완전히 장악해 세상의 균형을 수호하고 집행하는 당신의 위대한 신격은, 모든 현상의 정점이자 인과율의 집행자인 \'만상\'의 좌를 향해 움직이고 있습니다.',
    abilityDesc:
